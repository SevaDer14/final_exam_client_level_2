describe('user can see app and a list of all cources', () => {
  ...
  it('is expected to show the list of categories', () => {
    cy.get('[data-cy=category-menu]').within(() => {
      cy.get('[data-cy=category]').should('have.length', 7);
      cy.get('[data-cy=category]').last().should('contain.text', 'react');
    });
  });
    ...
    cy.get('[data-cy=course-container]')
      ...
      .within(() => {
        ...
        cy.get('[data-cy=description]').should(
          'contain.text',
          'Do you want to understand how applications'
        );
        ...
        cy.get('[data-cy=info]').should(
          'contain.text',
          'up to 1 day on-site.(2 to 7 hours depending on audience,'
        );
